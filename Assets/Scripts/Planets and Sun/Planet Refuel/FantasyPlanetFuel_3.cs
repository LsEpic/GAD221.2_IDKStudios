...
public class FantasyPlanetFuel_3 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("Player") && hasAddedFuelToShip == false)
        {
            ...
            Debug.Log(">Fantasy Planet 3< Increased ship fuel tank!");
    ...
    {
        fuelTextConfirmationReference.GetComponent<TextMeshProUGUI>().text = ">Fantasy Planet 3< Increased ship fuel tank!";
