...
public class FantasyPlanetFuel_1 : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("Player") && hasAddedFuelToShip == false)
        {
            ...
            Debug.Log(">Fantasy Planet 1< Increased ship fuel tank!");
    ...
    {
        fuelTextConfirmationReference.GetComponent<TextMeshProUGUI>().text = ">Fantasy Planet 1< Increased ship fuel tank!";
